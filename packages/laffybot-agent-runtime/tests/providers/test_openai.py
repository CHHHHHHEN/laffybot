...
class TestOpenRouter:
    ...
    def test_openrouter_headers_added(self) -> None:
        from laffybot_agent_runtime.providers.openai import _uses_openrouter_attribution
...
class TestLocalEndpoint:
    ...
    def test_localhost(self) -> None:
        from laffybot_agent_runtime.providers.openai import _is_local_endpoint
