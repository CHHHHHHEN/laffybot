...
## Python 代码质量 (agent_runtime)
（已合并到 laffybot/ 包中；涵盖在 laffybot/ 的检查范围内）
...
- Read `README.md` and `docs/` first to know basic information about project before launch subagents.